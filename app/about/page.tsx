      ...
      <section className='flex flex-col'>
        ...
        <div className='flex w-full flex-col items-center gap-5 rounded-b-lg bg-white p-5 sm:flex-row'>
          <span className='text-xl'>
            ...
            from nature. Every product we develop uses one hundred percent
            natural ingredients that preserve the purity of what we consume and
            ...
            <span className='font-bold text-red-800'>
              Between the years 2018 and 2022, Thailand saw a steady rise in
              mortality rates, reaching nine deaths per one thousand people in
              2022.
            </span>{' '}
      ...
      <section className='flex flex-col'>
        ...
        <div className='flex w-full flex-col items-center gap-5 rounded-b-lg bg-white p-5'>
          <span className='text-xl'>
            ...
            with regulations on Environtment, I’m dedicated to environmental
            sustainability and compliance management. Throughout my career, I
            have built a large social community and a deep connection with
            various sectors. The inception of Pure organic products emerged from
            my personal journey{' '}
            <span className='font-bold text-red-800'>
              towardswell-being and sustainability.
            </span>{' '}
            While navigating a period of{' '}
            <span className='font-bold text-red-800'>
              mental and physical distress
            </span>{' '}
            caused by the negative influences of alcoholism in my life, I was
            inspired to seek healing. Despite not being a consumer of alcohol, I
            was deeply affected by its destructive consequences on the people
            around me, which led to emotional unrest and physical issues. In
            search of peace and healing, I found honeyin the Mediterranean sea
            in Europe with natruallly and connection with nature deeply
            resonated with me. Through the beekeeper&apos;s guidance and my own
            exploration of nature, I found solace in the simplicity and beauty
            of the natural world, particularly in the peaceful harmony found in
            beekeeping, honey, and the surrounding forest. This newfound
            ...
            others. FAOS Premium Organic Collection as established to promote
            <span className='font-bold text-red-800'>
          ...
          <span className='text-xl'>
            Patcharin Chanaphukdee the founder of Pure organics Herbal, a
            visionary based in Bangkok, Thailand, the land historically known as{' '}
            <span className='font-bold text-red-800'>
              Suvaṇṇabhūmior the &quot;Land of Gold.&quot;
            </span>{' '}
            With 19 years of experience in globalization business and an MBA
            ...
            the people around me, which led to emotional unrest and physical
            issues. In search of peace and healing, I met a natrually and good
            food in the Mediterranean sea in Europe healing lifestyle and
            <span className='font-bold text-red-800'>
              connection with nature deeply resonated with me.
            </span>{' '}
            Through the health and wellness&apos;s guidance and my own
            exploration of nature, I found solace in the simplicity and beauty
            of the natural world, particularly in the peaceful harmony found in
            beekeeping, honey, and the surrounding forest. This newfound
            appreciation for nature played a significant role in calming my mind
            and emotions. My interest in natural healing led me to explore the
            ancient art of winemaking. I experimented with creating natural
            alcohol from{' '}
            <span className='font-bold text-red-800'>
              grapes and honey , other bloosom Flower, Herbal,
            </span>
            inspired by{' '}
            <span className='font-bold text-red-800'>
              traditional Mediterranean methods integrity with Asian
      ...
      <section className='flex flex-col'>
        ...
        <div className='flex w-full flex-col items-center gap-5 rounded-b-lg bg-white p-5'>
          <span className='text-xl'>
            ...
            <br />
            <b>Support heart health Promote overall well-being</b>
          </span>
        </div>
      </section>
      ...
      <section className='flex flex-col'>
        ...
        <div className='flex w-full flex-col items-center gap-5 rounded-b-lg bg-white p-5'>
          <span className='text-xl'>
            ...
            <span className='font-bold text-red-800'>
              from selecting the best organic forest to created to be a herbs
              and bottling
            </span>{' '}
