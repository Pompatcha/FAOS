...
export default function Home() {
  return (
    <div className='flex flex-col items-center gap-5 overflow-hidden bg-[#dda700]'>
      <div className='flex flex-col'>
        <Header />
        <Menu />
      </div>

      <div className='flex w-[80%] flex-col rounded-lg border-4 border-[#f3d27a] bg-gradient-to-r from-[#f9e6b3] to-[#f3d27a] p-5 text-center'>
      ...
      <div className='flex w-[80%] flex-col rounded-lg bg-[#bfa046] p-5 text-center shadow'>
      ...
      <div className='flex w-[80%] flex-col rounded-lg bg-white p-5'>
        <span>
          Created for Health, Elegance and Well-Being. Elevate patient care and
          hospitality with the FAOS Collection, a luxurious blend of Thai-Greek
          heritage, organic purity and health innovation. Designed for
          discerning healthcare environments that prioritize natural healing and
